...
private:
	...
	void freeData()
	{
		BE_ASSERT(this->data == nullptr, "Data is nullptr.")
		free(this->data);
		this->data = nullptr;
	}
...
public:
	...
	{
		BE_ASSERT(this == &other, "Assigning to self is not allowed!")
	...
	{
		BE_ASSERT(index < this->length, "Entered index is not accessible, array is not as large.")
