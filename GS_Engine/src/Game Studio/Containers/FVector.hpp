...
private:
	...
	void freeData()
	{
		GS_ASSERT(this->data == nullptr, "Data is nullptr.")
		free(this->data);
		this->data = nullptr;
	}
...
public:
	...
	{
		GS_ASSERT(this == &other, "Assigning to self is not allowed!")
	...
	{
		GS_ASSERT(index < this->length, "Entered index is not accessible, array is not as large.")
