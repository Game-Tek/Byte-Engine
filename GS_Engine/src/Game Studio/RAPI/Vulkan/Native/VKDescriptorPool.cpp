...
VKDescriptorPoolCreator::
VKDescriptorPoolCreator(VKDevice* _Device, const VkDescriptorPoolCreateInfo* _VkDPCI) : VKObjectCreator<VkDescriptorPool
>(_Device)
{
...
void VKDescriptorPool::AllocateDescriptorSets(const VkDescriptorSetAllocateInfo* _VkDSAI,
