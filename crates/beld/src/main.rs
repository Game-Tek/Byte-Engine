		...
		Commands::Bake { ids, sync } => {
...

			{
				...
				let shader_generator = {
					...
					let visibility_shader_generation = byte_engine::rendering::visibility_model::visibility_shader_generator::VisibilityShaderGenerator::new(false, false, false, false, false, false, true, false);
