...
//! Create an [`AudioSamplePlayer`] through the default world's player factory
//! when playback starts from a baked PCM resource.
...
pub use sample_player::{AudioSamplePlayer, PlaybackMode};
pub use sound::Sound;
