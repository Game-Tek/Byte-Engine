...
use crate::{core::{entity::{get_entity_trait_for_type, EntityBuilder, EntityTrait}, Entity, EntityHandle}, physics::{self, CollisionEvent}, rendering::mesh::MeshSource, Vector3};
...
impl Object {
	pub fn new<'a>(resource_id: &'static str, transform: Transform, body_type: physics::BodyTypes, velocity: Vector3) -> EntityBuilder<'a, Self> {
		...
		}).r#as::<Self>().r#as::<dyn physics::PhysicsEntity>().r#as::<dyn mesh::RenderEntity>()
	}
