...
fn shadow_light_is_visible_in_any_sink<T: Copy>(
	light: T,
	sinks: &[Sink],
...
fn select_fair_shadow_lights<T: Copy, const N: usize>(
...
fn candidate_for_sink_priority<T: Copy>(
...
fn shadow_light_is_more_important(left_index: usize, left_importance: f32, right_index: usize, right_importance: f32) -> bool {
...
fn cone_shadow_bounds(light: ConeLight) -> math::Sphere {
...
fn point_shadow_bounds(light: PointLight) -> math::Sphere {
...
fn cone_shadow_importance(light: ConeLight, sink: &Sink) -> Option<f32> {
...
fn point_shadow_importance(light: PointLight, sink: &Sink) -> Option<f32> {
