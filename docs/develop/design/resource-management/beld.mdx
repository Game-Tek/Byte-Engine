...
[Install BELD](/docs/develop/design/resource-management/install-beld) before you
...
Next, use BELD to [bake your application's resources](/docs/develop/design/resource-management/baking-app-resources).
