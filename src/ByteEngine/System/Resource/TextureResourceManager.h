...
public:
	...
	template<typename... ARGS>
	void LoadTexture(ApplicationManager* gameInstance, TextureInfo textureInfo, GTSL::Range<GTSL::uint8*> buffer, TaskHandle<TextureInfo, ARGS...> dynamicTaskHandle, ARGS&&... args) {
...
private:
	...
	template<typename... ARGS>
	void loadTexture(TaskInfo taskInfo, TextureInfo textureInfo, GTSL::Range<GTSL::uint8*> buffer, TaskHandle<TextureInfo, ARGS...> dynamicTaskHandle, ARGS... args) {
