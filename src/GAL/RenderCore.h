...
#define GAL_DEBUG_BREAK __builtin_trap();
	...
	namespace FORMATS {
		...
		static constexpr auto RG_S8 = FormatDescriptor(ComponentType::INT, 2, 8, TextureType::COLOR, 0, 1, 0, 0);
		static constexpr auto RG_I32 = FormatDescriptor(ComponentType::INT, 2, 32, TextureType::COLOR, 0, 1, 0, 0);
		static constexpr auto RG_F16 = FormatDescriptor(ComponentType::FLOAT, 2, 16, TextureType::COLOR, 0, 1, 0, 0);
