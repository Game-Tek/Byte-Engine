...
{	
	...
	public:
		...
		void Initialize(const VulkanRenderDevice* renderDevice, const GTSL::StringView name, const VulkanDeviceMemory deviceMemory, const GTSL::uint32 offset) {
			setName(renderDevice, image, VK_OBJECT_TYPE_IMAGE, name);
