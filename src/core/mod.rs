...
pub fn spawn<E: Entity>(entity: impl SpawnHandler<E>) -> EntityHandle<E> {
...
pub fn spawn_as_child<E: Entity>(parent: DomainType, entity: impl SpawnHandler<E>) -> EntityHandle<E> {
	static mut COUNTER: std::sync::atomic::AtomicU32 = std::sync::atomic::AtomicU32::new(0);
...
pub trait SpawnHandler<R: Entity> {
