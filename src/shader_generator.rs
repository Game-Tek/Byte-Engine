...
// 	// pub fn generate(&self, root: &Node, compilation_settings: &ShaderGenerationSettings) -> String {
// 	// 	let mut nodes = Vec::with_capacity(32);
...
// 	// 		let shader_stage = shader_stage.as_str();
...
// 	// 	fn process_node(string: Option<&mut String>, node: &Node, compilation_settings: &ShaderGenerationSettings, program_state: &mut ProgramState) {
// 	// 		match &node.node {
