...
fn gi() {
	...
	orchestrator.spawn(byte_engine::camera::Camera {
		position: Vec3f::new(0.0, 0.0, -2.0),
	...
	let _floor: EntityHandle<Mesh> = orchestrator.spawn(Mesh{ resource_id: "Box", material_id: "white_solid", transform: maths_rs::Mat4f::from_translation(Vec3f::new(0.0, 0.0, 0.0)), });
