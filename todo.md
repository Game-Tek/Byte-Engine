...
- Reduce conservative Metal compute memory barriers by deriving barriers from tracked resource access transitions in crates/ghi/src/metal/command_buffer.rs.
...
- Share Metal factory and context construction helpers for shaders, specialization constants, vertex layouts, pipelines, images, and samplers in crates/ghi/src/metal/factory.rs and crates/ghi/src/metal/context.rs.
- Optimize Metal array texture clears to avoid one render pass per slice where possible in crates/ghi/src/metal/command_buffer.rs.
- Simplify Metal render-pass attachment setup by resolving attachments once in crates/ghi/src/metal/command_buffer.rs.
- Avoid cloning Metal pipeline state during descriptor set binding in crates/ghi/src/metal/command_buffer.rs.
- Reduce full transition/resource state map cloning during Metal command buffer recording in crates/ghi/src/metal/command_buffer.rs and crates/ghi/src/metal/context.rs.
...
- Deduplicate Metal frame buffer and texture access helpers and fix inconsistent dynamic buffer staging handling in crates/ghi/src/metal/frame.rs.
