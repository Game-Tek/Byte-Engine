...
- Add `else` to BESL, then remove the SSGI workarounds for it from `crates/byte-engine/assets/rendering/visibility/ssgi-*.besl`. It needs the parser or lexer, the VM, and the MSL, HLSL, and GLSL backends.
